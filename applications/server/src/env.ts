...
export const env = createEnv({
  server: {
    ...
    DATABASE_HOST: Schema.NonEmptyString.pipe(Schema.standardSchemaV1),
    DATABASE_PORT: Schema.NumberFromString.pipe(
      Schemas.Optional(() => 5432),
      Schema.standardSchemaV1,
    ),
    DATABASE_MAIN: Schema.NonEmptyString.pipe(Schema.standardSchemaV1),
    DATABASE_NAME: Schema.NonEmptyString.pipe(Schema.standardSchemaV1),
    DATABASE_USER: Schema.NonEmptyString.pipe(Schema.standardSchemaV1),
    DATABASE_PASS: Schema.NonEmptyString.pipe(Schema.Redacted, Schema.standardSchemaV1),
    DISCORD_CLIENT_ID: Schema.NonEmptyString.pipe(Schema.standardSchemaV1),
    DISCORD_CLIENT_SECRET: Schema.NonEmptyString.pipe(Schema.Redacted, Schema.standardSchemaV1),
